/**
 * Per-profile identity for multi-account Dek Go usage tracking.
 *
 * @see issue #63
 */
import * as vscode from "vscode";

export const PROFILES_REGISTRY_KEY = "dekgo.profiles.v1";
export const ACTIVE_PROFILE_KEY = "dekgo.activeProfile.v1";
export const MIGRATED_KEY = "dekgo.migratedTo.v1";
export const LEGACY_SECRET_KEY = "dekgo.apiKey";
