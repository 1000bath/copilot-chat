...
**Reviewer:** ltmoerdani  
**PR:** [#76](https://github.com/1000bath/dek-copilot-chat/pull/76)  
**Issues:** [#74](https://github.com/1000bath/dek-copilot-chat/issues/74) (vision proxy), [#67](https://github.com/1000bath/dek-copilot-chat/issues/67) (output pane focus steal), [#68](https://github.com/1000bath/dek-copilot-chat/issues/68) (context overflow safety)  
**Merged:** 2026-07-15  
...
Single command: **Dek Go: Configure Vision Proxy** (`dekgo.configureVisionProxy`).
...
- `dekgo.visionProxyModelId` — target Copilot model ID (e.g. `copilot:gpt-5.5`)
- `dekgo.visionProxyPrompt` — description instruction sent to the vision model
...
| `package.json`                 | Register `dekgo.configureVisionProxy` command                                                                                                                                         | +4 / 0    |
...
| `notifyModelInfoChanged()` refresh trigger    | `src/extension.ts` `DekProvider` (~L1303)                         |
