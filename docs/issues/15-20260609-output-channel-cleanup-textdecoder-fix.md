...
| `media/dek-copilot-chat.svg` | Refreshed icon (from commit `c8383735`)                                                                                                      |
| `media/dek-copilot-chat.png` | Refreshed icon (from commit `c8383735`)                                                                                                      |
...
The "Dek Go Usage" output channel is also silenced (no callback passed to `GoUsageTracker`).
...
3. **Diagnostics are still available.** Removed logs were already accessible through the extension's diagnostics document (`Dek: Show Diagnostics`), so no diagnostic capability was lost.
