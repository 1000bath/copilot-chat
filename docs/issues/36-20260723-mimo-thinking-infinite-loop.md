...
MiMo uses `@ai-sdk/openai-compatible`. Dek's transform only sends `reasoningEffort` — no budget cap:
...
The extension logs diagnostic info to the "Dek" output channel:
