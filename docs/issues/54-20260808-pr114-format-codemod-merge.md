...
**Related:** PR [#114](https://github.com/1000bath/dek-copilot-chat/pull/114)
**Author:** [@Fahad090NP](https://github.com/Fahad090NP)
**Branch:** `chore/format-codemod`
**Predecessor:** PR [#110](https://github.com/1000bath/dek-copilot-chat/pull/110) (husky/eslint/markdownlint stack; pre-commit hook goes live on merge)
...
- PR: [#114](https://github.com/1000bath/dek-copilot-chat/pull/114)
- Predecessor (toolchain): [#110](https://github.com/1000bath/dek-copilot-chat/pull/110)
- Config source: [#108](https://github.com/1000bath/dek-copilot-chat/pull/108) (`.prettierrc.json`)
