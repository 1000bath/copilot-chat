...
Reason: Dek Zen API request failed (400) model=claude-opus-4-8
{"message":"temperature is deprecated for this model."}
```

**Related Issue:** [1000bath/dek-copilot-chat#20](https://github.com/1000bath/dek-copilot-chat/issues/20)
...
```bash
# List all PRs
gh pr list --repo 1000bath/dek-copilot-chat --state all --json number,title,state,headRefName,baseRefName

# Full diff review
gh pr diff 21 --repo 1000bath/dek-copilot-chat

# CI status checks
gh pr checks 21 --repo 1000bath/dek-copilot-chat
...
Review comment posted — [PR #21 comment](https://github.com/1000bath/dek-copilot-chat/pull/21#issuecomment-4692922424).
