...
`qwen3.6-plus-free` was labelled "Deprecated upstream" based on a community PR (#21855) to remove it. That PR was rejected ("closed abandoned") and Dek re-launched the model:
