...
**Related:** PR [#110](https://github.com/1000bath/dek-copilot-chat/pull/110)
**Author:** [@Fahad090NP](https://github.com/Fahad090NP)
**Branch:** `chore/tooling`
**Predecessor:** PR [#107](https://github.com/1000bath/dek-copilot-chat/pull/107) (scope split — original submission bundled tooling with the retry fix; maintainer requested a separate PR)
**Follow-up:** PR [#114](https://github.com/1000bath/dek-copilot-chat/pull/114) (format codemod)
...
- PR: [#110](https://github.com/1000bath/dek-copilot-chat/pull/110)
- Predecessor (scope split): [#107](https://github.com/1000bath/dek-copilot-chat/pull/107)
- Follow-up (codemod): [#114](https://github.com/1000bath/dek-copilot-chat/pull/114)
- Related config PR: [#108](https://github.com/1000bath/dek-copilot-chat/pull/108) (`.prettierrc.json`)
